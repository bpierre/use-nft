...
`,De={address:"0x16F5A35647D6F03D5D3da7b35409D65ba03aF3B2",methodName:"punkImageSvg",methodHash:"0x74beb047",humanReadableAbi:["function punkImageSvg(uint16 index) view returns (string svg)"]};function W(e){return I(e,"0xb47e3cd837ddf8e4c57f05d70ab865de6e193bbb")}var V=function(e,t){var r=t.jsonProxy;try{var n=r("https://api.cryptokitties.co/v3/kitties/"+e);return Promise.resolve(fetch(n)).then(function(i){return Promise.resolve(i.json()).then(function(o){var c,a,l,s=(c=o==null?void 0:o.image_url)!=null?c:"";return{description:(a=o==null?void 0:o.bio)!=null?a:"\u2212",image:s,imageType:s?"image":"unknown",metadataUrl:n,name:(l=o==null?void 0:o.name)!=null?l:"Unknown",owner:"",rawData:o}})})}catch(i){return Promise.reject(i)}};function G(e){return I(e,"0x06012c8cf97BEaD5deAe237070F9587f8E7A266d")}var J=function(e){try{return Promise.resolve(fetch(Ce,{body:Ne("0x959e104E1a4dB6317fA58F8295F586e1A978c297",e),method:"POST"})).then(function(t){return Promise.resolve(t.json()).then(function(r){var n,i,o,c,a,l,s,p,u=r.data,d=u==null||(n=u.nfts)==null?void 0:n[0],m=(i=d==null?void 0:d.image)!=null?i:"";return{description:(o=d==null||(c=d.estate)==null||(a=c.data)==null?void 0:a.description)!=null?o:"\u2212",image:m,imageType:m?"image":"unknown",metadataUrl:"",name:(l=d==null?void 0:d.name)!=null?l:"Unknown",owner:(s=d==null||(p=d.owner)==null?void 0:p.address)!=null?s:"",rawData:u}})})}catch(t){return Promise.reject(t)}},Ce="https://api.thegraph.com/subgraphs/name/decentraland/marketplace";function Ne(e,t){return JSON.stringify({operationName:"NFTByTokenId",variables:{contractAddress:e,tokenId:t},query:`
